...
/bin/sed -i "s/short_open_tag\ \=\ Off/short_open_tag\ \=\ On/g" /etc/php/5.6/apache2/php.ini
...
cat << EOB
    ...
    **********************************************
    *                                            *
    *    Docker image: mairoot/lamp               *
    *    https://github.com/mairoot/docker-lamp   *
    *                                            *
    **********************************************
    SERVER SETTINGS
    ---------------
...
# Set PHP timezone
/bin/sed -i "s/\;date\.timezone\ \=/date\.timezone\ \=\ ${DATE_TIMEZONE}/" /etc/php/5.6/apache2/php.ini
